        ...
        children: [
          {
            ...
            icon: <i className="fa fa-opera"></i>,
            to: "?tipo=calzado&genero=hombre&category=zapatilla",
          },
          {
            id: 9,
            title: "Zapatillas",
          ...
          },
          {
            ...
            title: "Sandalias",
            icon: <i className="fa fa-opera"></i>,
            to: "?tipo=calzado&genero=hombre&category=sandalia",
          },
          // ,
          // {
          //   id: 9,
        ...
        children: [
          {
            ...
            title: "Ver Todas las Zapatillas",
            icon: <i className="fa fa-opera"></i>,
            to: "?tipo=calzado&genero=mujer&category=zapatilla",
          },
          {
            id: 3,
            title: "Zapatillas",
          ...
          },
          {
            ...
            title: "Sandalias",
            icon: <i className="fa fa-opera"></i>,
            to: "?tipo=calzado&genero=mujer&category=sandalia",
          },
          // ,
          // {
          //   id: 3,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: "Sandalias",
            icon: <i className="fa fa-opera"></i>,
            url: "?tipo=sandalia&genero=niños",
          },
        ],
      },
    ],
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: "Sandalias",
            icon: <i className="fa fa-opera"></i>,
            url: "?tipo=sandalia&genero=mujer",
          },
          // {
          //   id: 3,
          //   title: "Running",
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: "Sandalias",
            icon: <i className="fa fa-opera"></i>,
            url: "?tipo=sandalia&genero=hombre",
          },
          // ,
          // {
          //   id: 9,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: "Polos",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=polo",
          },
          ,
          {
            id: 3,
            title: "Poleras",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=polera",
          },
          // {
          //   id: 3,
          //   title: "Licras",
          ...
          // },
          {
            ...
            title: "Casacas",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=casaca",
          },
          {
            id: 3,
            title: "Pantalones",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=pantalon",
          },
          {
            id: 3,
            title: "Camisetas de Futbol",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=camiseta",
          },
          {
            id: 9,
            title: "Shorts",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=shorts",
          },
          {
            id: 3,
            title: "Buzos",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=buzo",
          },
        ],
      },
      {
        ...
        children: [
          ...
          // },
          {
            ...
            title: "Mochilas",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=mochila",
          },
          // {
          //   id: 1,
          //   title: "Guantes",
          ...
          // },
          {
            ...
            title: "Gorras",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=gorra",
          },
          {
            id: 1,
            title: "Medias",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=medias",
          },
          {
            id: 1,
            title: "Tomatodos",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=tomatodo",
          },
          {
            id: 1,
            title: "Bolsos",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=ropa&genero=hombre&category=bolso",
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            title: "Ver Todas las Zapatillas",
            icon: <i className="fa fa-opera"></i>,
            url: "?search=&tipo=calzado&genero=niños",
          },
          {
            id: 3,
            title: "Zapatillas",
